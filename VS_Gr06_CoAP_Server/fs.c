...
//
//     ../../../../tools/bin/makefsfile -i fs -o myfsdata.h -r -h -q
//
...
//
//*****************************************************************************
#include <fsdata_serverCertificateAndKey.h>
...
struct fs_file * fs_open(const char *pcName)
{
    ...
    // Check for special filenames (used by JavaScript) if applicable
    if(0){
...
{
    int iAvailable; // size int = size long = 32bit for ARM CORTEX M4
